...
public class Main extends Application {
    ...
    @Override public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setScene(Pipeliner.of(() -> new Scene(ContainerFactory.createSceneRoot(BorderPane::new), primaryScreenVisualBounds.getWidth() / 6, primaryScreenVisualBounds.getHeight() / 3))
